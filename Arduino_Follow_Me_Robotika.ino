...
#define MAX_DISTANCE 500      // Maximum ping distance:

unsigned int distance = 0.034 / 2;    //Variable to store ultrasonic sensor distance:
unsigned int Right_Value = 100; //Variable to store Right IR sensor value:
unsigned int Left_Value = 100;  //Variable to store Left IR sensor value:
